...
public final class MyServiceGrpc {
   ...
   */
  public static MyServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<MyServiceBlockingV2Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<MyServiceBlockingV2Stub>() {
        @java.lang.Override
        public MyServiceBlockingV2Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
          return new MyServiceBlockingV2Stub(channel, callOptions);
        }
      };
    return MyServiceBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class MyServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<MyServiceBlockingV2Stub> {
    private MyServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected MyServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new MyServiceBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service MyService.
   * <pre>
   * Define the gRPC Service
   * </pre>
   */
